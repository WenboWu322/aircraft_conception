...
"""This script implements a tree algorithm to check the feasability of each Arrangement.
...
# TODO : in Marilib 2.0, the wing_type is always fixed to 'classic'
          ...
          "tank_architecture":    ["wing_box"   , "under_floor", "rear"         , "pods"      , "piggy_back", ""       , ""         ],
          "gear_architecture":    ["retractable", "bare_fixed" , ""             , ""          , ""          , ""       , ""         ],
          "number_of_engine":     ["twin"       , "quadri"     , "hexa"         , ""          , ""          , ""       , ""         ],
          "nacelle_attachment" :  ["wing"       , "rear"       , "pods"         , "body_cones", ""          , ""       , ""         ],
          "power_architecture":   ["tf"         , "tp"         , "ef"           , "ep"        , "pte"       , "pte_pod", "pte_piggy"],
          "power_source" :        ["fuel"       , "fuel_cell"  , "fuel_cell_PEM", "battery"   , ""          , ""       , ""         ],
          "fuel_type":            ["kerosene"   , "liquid_h2"  , "compressed_h2", "battery"   , ""          , ""       , ""         ]
          }
...
INCOMPATIBILITY_DICT = {
    ...
    "nacelle_attachment": {
        ...
        "pods": {
            "tank_architecture": ["wing_box", "under_floor", "piggy_back"],
            "number_of_engine": ["quadri","hexa"]
        },
        "body_cones": {
            "tank_architecture": ["wing_box", "under_floor", "rear", "pods"],
            "number_of_engine": ["quadri","hexa"]
        }
    },
    "power_architecture": {
        "pte_pod": {
            "tank_architecture": ["wing_box", "under_floor", "rear", "piggy_back"],
            "nacelle_attachment": ["pods"]
        },
        "pte_piggy": {
            "tank_architecture": ["wing_box", "under_floor", "rear", "pods"],
    ...
    "power_source": {
        "fuel_cell": {
            "power_architecture": ["tf", "tp","pte","pte_pod","pte_piggy"]
        },
        "fuel_cell_PEM": {
            "power_architecture": ["tf", "tp","pte","pte_pod","pte_piggy"]
        },
    ...
    "fuel_type": {
        "battery": {
            ...
            "power_source": ["fuel", "fuel_cell", "fuel_cell_PEM"]
        },
        "kerosene": {
            "power_architecture": ["ef", "ep"],
            "power_source": ["fuel_cell", "fuel_cell_PEM", "battery"]
        },
        "methane": {
            "power_architecture": ["ef", "ep"],
            "power_source": ["fuel_cell", "fuel_cell_PEM", "battery"]
...
fig = plt.figure("Design browser",figsize=(13,7))
ax = plt.subplot(111)
ax.set_xlim([0,1])
ax.set_ylim([0,1])
ax.axis("off")

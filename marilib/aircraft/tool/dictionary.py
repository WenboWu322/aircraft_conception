...
DATA_DICT = {
    ...
    "gear_architecture": {"unit":"string", "mag":10, "txt":"Type of landing gears, 'retractable', 'bare_fixed'"},
    ...
    "ref_length": {"unit":"m", "mag":1e0, "txt":"Reference length of the component"},
    "section_type": {"unit":"string", "mag":9, "txt":"Type body section shape, 'elipse', 'square'"},
    ...
    "forward_ratio": {"unit":"no_dim", "mag":1e0, "txt":"Distance from fuselage nose to cabinwall over fuselage diameter"},
    "rear_bulkhead_ratio": {"unit":"no_dim", "mag":1e0, "txt":"Distance from rear pressure bulkhead to fuselage end over fuselage diameter"},
    "width_rear_factor": {"unit":"no_dim", "mag":1e0, "txt":"Diameter of the rear pressure bulkhead over fuselage diameter"},
    "max_body_aspect_ratio": {"unit":"no_dim", "mag":1e0, "txt":"Maximum ratio of fuselage length over fuselage height"},
    ...
    "nose_cone_ratio": {"unit":"no_dim", "mag":1e0, "txt":"Fuselage nose cone length over fuselage diameter"},
    "nose_cone_length": {"unit":"m", "mag":1e1, "txt":"Length of the tapered forward part of the main body"},
    ...
    "wheel_count": {"unit":"int", "mag":1e0, "txt":"Number of wheels of the main landing gear"},
    "wheel_diameter": {"unit":"m", "mag":1e0, "txt":"Diameter of wheels of the main landing gear"},
    "wheel_width": {"unit":"m", "mag":1e0, "txt":"Width of wheels (or boggy) of the main landing gear"},
    "wheel_drag_area_factor": {"unit":"no_dim", "mag":1e0, "txt":"Drag area over (dynamic pressure x frontal area"},
    "ldg_mass": {"unit":"kg", "mag":1e3, "txt":"Landing gear mass"},
    "mass_correction_factor": {"unit":"no_dim", "mag":1e0, "txt":"Factor on all component mass except engines and systems"},
    ...
    "pax_max_bwd_cg": {"unit":"m", "mag":1e1, "txt":"Maximum backward position of the passengers"},
    ...
    "freight_max_bwd_cg": {"unit":"m", "mag":1e1, "txt":"Maximum backward position of the freight"},
    ...
    "aisle_width": {"unit":"m", "mag":1e0, "txt":"Aisle width in economy class"},
    "seat_width": {"unit":"m", "mag":1e0, "txt":"Seat width in economy class"},
    "seat_pitch": {"unit":"m", "mag":1e0, "txt":"Seat pitch in economy class"},
    ...
    "m_pax_cabin": {"unit":"int", "mag":1e2, "txt":"Reference mass allowance per passenger inside the cabin, passenger + hand luggage"},
    ...
    "front_spar_ratio": {"unit":"no_dim", "mag":1e0, "txt":"Relative chord position of front spar"},
    "rear_spar_ratio": {"unit":"no_dim", "mag":1e0, "txt":"Relative chord position of rear spar"},
    ...
    "aoa_wing": {"unit":"deg", "mag":1e0, "txt":"Wing angle of attack"},
    ...
    "gravimetric_index": {"unit":"no_dim", "mag":1e0, "txt":"Tank gravimetric index, kg-LH2 / kg-LH2+Tank"},
    "volumetric_index": {"unit":"no_dim", "mag":1e0, "txt":"Tank volumetric index, m3-LH2 / m3-LH2+Tank"},
    ...
    "cantilever_gross_volume": {"unit":"m3", "mag":1e1, "txt":"Tank gross volume outside of the main body"},
    "cantilever_volume": {"unit":"m3", "mag":1e1, "txt":"Tank volume outside of the main body"},
    "central_gross_volume": {"unit":"m3", "mag":1e1, "txt":"Tank gross volume inside of the main body"},
    "central_volume": {"unit":"m3", "mag":1e1, "txt":"Tank volume inside of the main body"},
    "structure_shell_surface_mass": {"unit":"kg/m2", "mag":1e1, "txt":"Surface mass of the tank structural shell"},
    "structure_shell_thickness": {"unit":"m", "mag":1e0, "txt":"Tank structural shell thickness"},
    ...
    "dry_bay_length": {"unit":"m", "mag":1e1, "txt":"Length of the dry bay inside a tank"},
    "mfw_volume_limited": {"unit":"kg", "mag":1e3, "txt":"Maximum fuel mass according to available volume"},
    "gross_volume": {"unit":"m3", "mag":1e1, "txt":"Gross volume of the component"},
    ...
    "wing_axe_z": {"unit":"m", "mag":1e1, "txt":"Z wise position of the wing chord at component axis span wise position"},
    ...
    "nacelle_wing_chord": {"unit":"m", "mag":1e0, "txt":"Wing chord at nacelle Y wise position, wing engine only"},
    "nacelle_wing_chord_loc": {"unit":"m", "mag":1e0, "txt":"Wing chord position at nacelle Y wise position, wing engine only"},
    "x_loc_ratio": {"unit":"no_dim", "mag":1e0, "txt":"Fraction of the component length behind the wing"},
    ...
    "sea_level_static_thrust": {"unit":"daN", "mag":1e5, "txt":"Engine max thrust at sea level zero speed"},
    ...
    "cooling_efficiency": {"unit":"no_dim", "mag":1e0, "txt":"Cooling efficiency, ex: 0.01 means that the required power to cool the system is 1% of the dissipated power"},
    "cooling_pw_density": {"unit":"kW/kg", "mag":1e1, "txt":"Cooling power density, the ratio of the dissipated power over the required system mass to dissipate it"},
    ...
    "chain_power_piggyback": {"unit":"kW", "mag":1e3, "txt":"Electric power of the piggyback mounted chain"},
    "chain_power_body": {"unit":"kW", "mag":1e3, "txt":"Electric power of body mounted chain"},
    "chain_power_pod": {"unit":"kW", "mag":1e3, "txt":"Electric power of pod mounted chain"},
    "gross_cylindric_volume": {"unit":"m3", "mag":1e2, "txt":"Available volume for tank in the rear fuselage cylindrical part"},
    "gross_cone_volume": {"unit":"m3", "mag":1e2, "txt":"Available volume for tank in the rear fuselage conic part"},
    "cylindric_volume": {"unit":"m3", "mag":1e2, "txt":"Rear tank fuel volume in the cylindrical part"},
    "cone_volume": {"unit":"m3", "mag":1e2, "txt":"Rear tank fuel volume in the conic part"},
    "pod_tank_built_area": {"unit":"m2", "mag":1e2, "txt":"External built area of pod tank"},
    "pod_tank_overall_volume": {"unit":"m3", "mag":1e2, "txt":"Overall volume of pod tank"},
    "pod_tank_internal_volume": {"unit":"m3", "mag":1e2, "txt":"Internal volume of pod tank"},
    "pod_tank_shell_volume": {"unit":"m3", "mag":1e2, "txt":"Volume of the structural shell of pod tank"},
    "pod_tank_shell_mass": {"unit":"kg", "mag":1e2, "txt":"Mass of the structural shell of pod tank"},
    "fuel_volume": {"unit":"m3", "mag":1e2, "txt":"Maximum fuel volume in the tank"},
    "fuel_mass": {"unit":"kg", "mag":1e2, "txt":"Maximum fuel mass in the tank"},
    "battery": {"unit":"string", "mag":3, "txt":"Use of battery, 'yes', 'no'"},
    "cruise_energy": {"unit":"kWh", "mag":1e2, "txt":"Stored energy dedicated to the cruise phase"},
    "lto_power": {"unit":"kW", "mag":1e2, "txt":"Battery power reserve for take off and landing"},
    "lto_time": {"unit":"min", "mag":1e1, "txt":"Duration of availability of the power reserve"},
    ...
    "fuel_cell_output_power_ref": {"unit":"kW", "mag":1e5, "txt":"Fuell cell nominal output power"},
    "heat_power_ref": {"unit":"kW", "mag":1e5, "txt":"Fuell cell nominal heat power"},
    "fuel_cell_mass": {"unit":"kg", "mag":1e3, "txt":"Fuell cell mass"},
    "compressor_over_pressure": {"unit":"bar", "mag":1e0, "txt":"Total air pressure at fuel cell entry"},
    "compressor_efficiency": {"unit":"no_dim", "mag":1e0, "txt":"Compressor efficiency, power delivered to the air flow over input power"},
    "compressor_pw_density": {"unit":"kW/kg", "mag":1e0, "txt":"Compressor total power density"},
    "compressor_power_ref": {"unit":"kW", "mag":1e0, "txt":"Nominal electrical power of the air compressor"},
    "compressor_mass": {"unit":"no_dim", "mag":1e0, "txt":"Mass of compressor system"},
    "cooling_power_index": {"unit":"no_dim", "mag":1e-2, "txt":"Cooling efficiency, ex: 0.01 means that the required power to cool the system is 1% of the dissipated power"},
    "cooling_gravimetric_index": {"unit":"kW/kg", "mag":1e1, "txt":"Cooling power density, the ratio of the dissipated power over the required system mass to dissipate it"},
    "cooling_power_ref": {"unit":"kW", "mag":1e0, "txt":"Nominal electrical power of the cooling system"},
    "cooling_mass": {"unit":"kg", "mag":1e2, "txt":"Mass of the cooling system"},
    ...
    "height_ratio": {"unit":"no_dim", "mag":1e0, "txt":"Horizontal tail height ratio versus vertical tail height"},
    ...
    "sfc_correction": {"unit":"no_dim", "mag":1e0, "txt":"Factor on tsfc or psfc"},
    ...
    "psfc_reference": {"unit":"lb/shp/h", "mag":1e0, "txt":"Reference Specific Fuel Consumption versus Power"},
    ...
    "dcx_correction": {"unit":"no_dim", "mag":1e-4, "txt":"Additive correction on airplane total drag coefficient"},
    "kcx_correction": {"unit":"no_dim", "mag":1e-4, "txt":"Factor on airplane total drag coefficient"},
    ...
    "mfw_factor": {"unit":"no_dim", "mag":1e0, "txt":"Driver of MFW in MDA_plus mode"},
    "owe_cg": {"unit":"m", "mag":1e1, "txt":"Center of gravity at Operational Weight Empty"},
    "static_stab_margin": {"unit":"no_dim", "mag":1e0, "txt":"Minimal static margin in CMA ratio"},
    "forward_cg_mass": {"unit":"kg", "mag":1e5, "txt":"Total mass corresponding to required max forward CG"},
    "forward_cg_req": {"unit":"m", "mag":1e1, "txt":"Required max forward CG position"},
    "forward_cg_stall": {"unit":"m", "mag":1e1, "txt":"Allowable max forward CG position according to stall demonstration"},
    "backward_cg_mass": {"unit":"kg", "mag":1e5, "txt":"Total mass corresponding to required max backward CG"},
    "backward_cg_req": {"unit":"m", "mag":1e1, "txt":"Required max backward CG position"},
    "backward_cg_stab": {"unit":"m", "mag":1e1, "txt":"Allowable max backward CG position according to static stability"},
    "backward_cg_oei_mass": {"unit":"kg", "mag":1e5, "txt":"Total mass corresponding to oei lateral trim demonstration"},
    "backward_cg_oei_trim": {"unit":"m", "mag":1e1, "txt":"Allowable max backward CG position according to oei lateral trim demonstration"},
    ...
    "max_fuel_range_factor": {"unit":"no_dim", "mag":1e0, "txt":"Ratio max_fuel_range over design range in MDO_plus mode"},
    ...
    "crz_tas": {"unit":"kt", "mag":1e2, "txt":"Cruise true air speed"},
    ...
    "crz_wing_aoa": {"unit":"deg", "mag":1e0, "txt":"Cruise wing angle of attack, pitch angle as well"},
    "crz_fuselage_aoa": {"unit":"deg", "mag":1e0, "txt":"Cruise fuselage angle of attack, pitch angle as well"},
    ...
    "crz_propulsive_power": {"unit":"MW", "mag":1e0, "txt":"Total cruise propulsive power, total_thrust * true_air_speed"},
    "crz_engine_input_power": {"unit":"kW", "mag":1e2, "txt":"Motor input electrical power"},
    ...
    "max_sar_tas": {"unit":"kt", "mag":1e2, "txt":"True air speed at specific air range"},

...
class ModelConfiguration(object):
    ...
    def __init__(self):
        ...
        "TankWingBox":{
            "gravimetric_index": [0.30, "no_dim", "Ratio Fuel_mass / (Fuel_mass + Tank_mass)"],
            "volumetric_index": [0.65, "no_dim", "Ratio Fuel_mass / Total_tank_volume"],
        ...
        "SystemWithFuelCell":{
            ...
            "fuel_cell_pw_density": [2., "kW/kg", "Fuel cell power density"],
            "fuel_cell_efficiency": [0.5, "no_dim", "Fuel cell conversion efficiency"]
        },

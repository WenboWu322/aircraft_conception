...
agmt = Arrangement(body_type = "fuselage",           # "fuselage"
                   ...
                   power_architecture = "ep",        # "tf", "tp", "ef", "ep", "pte", "pte_pod", "pte_piggy"
                   power_source = "fuel_cell",       # "fuel", "fuel_cell", "fuel_cell_PEM", "battery"
...
# overwrite default specific values for sensitivity analysis
